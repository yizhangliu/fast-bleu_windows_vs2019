...
def _load_cdll():
    import os
    curr_path = os.path.dirname(__file__) + os.path.sep
    if platform.system() == 'Windows':
        lib_file = curr_path + 'fast-bleu.dll'
    else:
        lib_file = curr_path + '__fast_bleu_module.so'
    # print(curr_path)
    return ctypes.CDLL(lib_file, use_errno=True)
