...
extern "C" _declspec(dllexport) void *get_bleu_instance(PyObject *lines_of_tokens, PyObject *weights,
...
extern "C" _declspec(dllexport) void *get_bleu_score(void *bleu_ptr, PyObject *hypotheses)
{
    try
    {
...
extern "C" _declspec(dllexport) void *del_bleu_instance(void *bleu_ptr)
{
    delete ((BLEU_CPP *)bleu_ptr);
    return 0;
}

extern "C" _declspec(dllexport) void *get_selfbleu_instance(PyObject *lines_of_tokens, PyObject *weights,
                                       int max_n, int smoothing_func, bool auto_reweight, bool verbose)
{
    try
    {
...
extern "C" _declspec(dllexport) void *get_selfbleu_score(void *selfbleu_ptr)
{
    try
    {
...
extern "C" _declspec(dllexport) void *del_selfbleu_instance(void *selfbleu_ptr)
{
